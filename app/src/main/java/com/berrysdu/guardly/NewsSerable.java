...
public class NewsSerable implements Serializable{
        ...
        public NewsSerable(String title_, String publishTime_, String webUrl_, String tag_){
            title=title_;publishTime=publishTime_;webUrl=webUrl_;tag=tag_;
        }
        public NewsSerable(News news){
            title=news.getTitle();
